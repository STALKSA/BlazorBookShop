...
2. Написать юнит-тесты для метода регистрации пользователя( для создания моков воспользоваться [библиотекой Moq](https://github.com/devlooped/moq), применить библиотеку FluentAssertions в тестах, генерировать тестовые данные при помощи библиотеки Bogus,сдобиться максимального покрытия).
